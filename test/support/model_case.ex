defmodule Hacktiv8Challenges.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import Hacktiv8Challenges.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&Hacktiv8Challenges.ErrorHelpers.translate_error/1)
